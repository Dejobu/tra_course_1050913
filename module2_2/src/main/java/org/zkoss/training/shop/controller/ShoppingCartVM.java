...
public class ShoppingCartVM {
	...
	@GlobalCommand
	public void addToCart(@BindingParam("prod") Product product,
			@BindingParam("quantity") int quantity) {
		getCartManager().add(new CartItem(product, quantity));
		cartModel.clear();
		cartModel.addAll(getCartManager().listItems());
	...
	@Command(CLEAR)
	@NotifyChange({"comment", "selectedCartItem"})
	public void clear() {
